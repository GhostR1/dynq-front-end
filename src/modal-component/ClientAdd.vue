      ...
      <b-row class="justify-content-md-center mt-4">
        <b-col col md="8">
          <b-card header-bg-variant="dark"
            ...
            <template #header>
              <b-navbar-brand >Add a new client</b-navbar-brand>
            ...
            <b-form @submit="onSubmit">
              ...
              <b-form-group  label-cols="4" label-cols-lg="4" label="Phone" label-for="input-name">
  ...
  computed: {
    acceptableVerificationStyle() {
      return (this.Name.length > 0  && this.Surname.length > 0 &&
          ...
          this.Password.length > 0 && this.Phone.length > 0) ? "dark" : "outline-dark";
    },
    acceptableVerification() {
      return !(this.Name.length > 0 && this.Surname.length > 0 &&
          this.SecondName.length > 0 && this.Email.length > 0 &&
          this.Password.length > 0 && this.Phone.length > 0);
    }
  }
}
</script>